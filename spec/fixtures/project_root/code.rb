module Celerbrake
  ...
  class Notice
    ...
    ##
    # Ignores a notice. Ignored notices never reach the Celerbrake dashboard.
    #
    # @return [void]
    # @see #ignored?
    ...
    def raise_if_ignored
      ...
      raise Celerbrake::Error, 'cannot access ignored notice'
    end
    ...
    def extract_custom_attributes(exception)
      ...
      begin
        ...
        @config.logger.error(
          "#{LOG_LABEL} #{exception.class}#to_celerbrake failed:" \
