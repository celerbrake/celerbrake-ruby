RSpec.describe Celerbrake::Filters::GitLastCheckoutFilter do
  ...
  context "when .git directory exists" do
    context "when CELERBRAKE_DEPLOY_USERNAME env variable is set" do
      before do
        ENV['CELERBRAKE_DEPLOY_USERNAME'] = 'deployer'
      end
    ...
    context "when CELERBRAKE_DEPLOY_USERNAME env variable is NOT set" do
      before { ENV['CELERBRAKE_DEPLOY_USERNAME'] = nil }
