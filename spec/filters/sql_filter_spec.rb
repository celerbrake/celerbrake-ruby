RSpec.describe Celerbrake::Filters::SqlFilter do
  ...
  shared_examples "query blocklisting" do |query, opts|
    it "ignores '#{query}'" do
      ...
      q = Celerbrake::Query.new(query: query, method: 'GET', route: '/', timing: 1)
      filter.call(q)
  ...
  [
    {
      ...
      input: "SELECT * FROM table WHERE name='foo'' AND color='blue'",
      output: "Error: Celerbrake::Query was not filtered",
      dialects: all_dialects,
    }, {
