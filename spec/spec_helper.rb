...
require 'English'
require 'base64'
require 'ostruct' # No longer autoloaded as of Ruby 3.4; specs use OpenStruct.
...
class CelerbrakeTestError < RuntimeError
  ...
  def initialize(*)
    ...
    @backtrace = [
      "/home/kyrylo/code/celerbrake/ruby/spec/spec_helper.rb:23:in `<top (required)>'",
      "/opt/rubies/ruby-2.2.2/lib/ruby/2.2.0/rubygems/core_ext/kernel_require.rb:54:in `require'",
      "/opt/rubies/ruby-2.2.2/lib/ruby/2.2.0/rubygems/core_ext/kernel_require.rb:54:in `require'",
      "/home/kyrylo/code/celerbrake/ruby/spec/celerbrake_spec.rb:1:in `<top (required)>'",
...
class JavaCelerbrakeTestError < CelerbrakeTestError
  def initialize(*)
    super
    # rubocop:disable Layout/LineLength
    @backtrace = [
