RSpec.describe Celerbrake::RemoteSettings::Callback do
  describe "#call" do
    ...
    let(:data) do
      instance_double(Celerbrake::RemoteSettings::SettingsData)
    end
    ...
    context "when error_host returns a value" do
      it "sets the error_host option" do
        config.error_host = 'http://api.celerbrake.com'
    ...
    context "when error_host returns nil" do
      it "doesn't modify the error_host option" do
        ...
        described_class.new(config).call(data)
        expect(config.error_host).to eq('http://api.celerbrake.com')
      end
    end

    context "when apm_host returns a value" do
      it "sets the apm_host option" do
        config.apm_host = 'http://api.celerbrake.com'
    ...
    context "when apm_host returns nil" do
      it "doesn't modify the apm_host option" do
        ...
        described_class.new(config).call(data)
        expect(config.apm_host).to eq('http://api.celerbrake.com')
      end
    end
  end
end
